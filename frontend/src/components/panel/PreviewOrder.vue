...
.order-process
  .division-process(v-if="order.orderType === 'division'")
    .column
      .process-row
        .current-rank
          img.rank-image(:src="`https://storage.googleapis.com/divine-boost-bucket/assets/assets/ranks/league-of-legends/${order.currentRank.division}.webp`" alt="rank-image")
        ...
        .desired-rank
          img.rank-image(:src="`https://storage.googleapis.com/divine-boost-bucket/assets/assets/ranks/league-of-legends/${order.desiredRank.division}.webp`" alt="rank-image")
