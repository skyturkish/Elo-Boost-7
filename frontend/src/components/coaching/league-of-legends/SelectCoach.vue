...
CheckoutSelection(toolTipText="You can choose your favorite coach" title="COACH")
  v-img.logo(v-if="currentLeagueOfLegendsOrder.coach == null" src='@/assets/icons/plus.png' width="50px")
  v-img.logo.booster-photo(v-else :src='currentLeagueOfLegendsOrder.coach.photo' width="50px")
